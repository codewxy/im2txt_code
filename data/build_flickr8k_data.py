...
tf.flags.DEFINE_string("output_dir", "./tfrecord", "Output data directory.")
...
tf.flags.DEFINE_string("word_counts_output_file", "./tfrecord/word_counts.txt",
...
def _load_and_process_metadata(image_file,captions_file, image_dir="Flickr8k_Dataset/Flicker8k_Dataset"):
